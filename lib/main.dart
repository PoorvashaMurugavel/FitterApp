...
import 'Widgets/BackgroundChanger.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(title: 'Welcome To Flutter', debugShowCheckedModeBanner: false, home: OXGame());
  }
}
...
class _RandomWordState extends State<RandomWords> {
  ...
  void _pushSaved() {
    Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => Suggestions(savedlist: _saved)));
  }
}
